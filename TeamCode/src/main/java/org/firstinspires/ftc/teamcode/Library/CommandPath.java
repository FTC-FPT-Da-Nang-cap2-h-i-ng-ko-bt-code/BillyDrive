...
import org.firstinspires.ftc.teamcode.StrafePIDConfig;

public class CommandPath {
    public LocalizerTwoWheel localizerTwoWheel;
    ...
    public CommandPath(HardwareMap hardwareMap, DcMotorEx leftFront, DcMotorEx leftBack, DcMotorEx rightFront, DcMotorEx rightBack,
        ...
        localizerTwoWheel = new LocalizerTwoWheel(hardwareMap, "m3", "m0", new Pose2D(0, 0, 0));
